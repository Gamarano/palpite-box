...
Por isso, estamos sempre abertos a ouvir a sua opinião.</p>
      {!sucess && <div className='w-1/5 mx-auto'>
        ...
        <label className='font-bold'>Opiniao:</label>
        <input type='text' className='p-4 block shadow bg-blue-100 my-2 rounded' placeholder='Opiniao' onChange={onChange} name='Opiniao' value={form.Opiniao} />
